	...
	<form method="post">
		<div id="header">
			<ul id="navbar">
				...
				<li class="lists"><a class="options" href="my-cv.php">CV</a>
					<ul id="sub_bar">
						<li class="sub_lists"><a class="sub_options" href="my-cv.php">My CV</a></li>
				...
				<li id="log_list"><a id="log_option" href="index.php?logout='1'">
